...
def get_games_and_data(page: str) -> dict:
    ...
    with open('known_game_data.json', 'r') as file:
    ...
    if new_games:
        ...
        with open('known_game_data.json', "w") as file:
...
def get_OSTs(games: tuple, manually_provide_playlist=False, elaborate_search=False) -> dict:
    music_entries = {}
    with open('known_game_music.json', 'r') as file:
        ...
        if g in tuple(known_music.keys()):
            ...
            if videos_are_okay:
                ...
                if manually_provide_playlist:
                    with open('known_game_music.json', 'w') as file:
